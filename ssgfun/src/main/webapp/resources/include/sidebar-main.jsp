...
<head>
  ...
  <![endif]-->
  <link rel="stylesheet" type="text/css" href="assets/csss/mainStyle.css" />
  <style type="text/css">
  .bottom-sidebar {
  	position: relative;
    top: 280px;
       		...
       		<div class="am-logo">
	        	<div class="row" style="position:relative;top:20%;">
	       			<a href="/ssgin/main.app">
		        		<img src="assets/img/logo/ssgin_letter.png">
		        		<span style="position:relative;left:-10%;top:2px;"><i class="s7-home"></i></span>
	        		</a>
	       		</div>
	        	<div class="row" style="position:relative;top:5%;">
		        	<img src="assets/img/logo/chain.png" style="width:8%;top:5px;position:relative;">
