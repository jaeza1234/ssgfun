			...
			<div class="col-md-6">
				<div class="widget widget-calendar">
					<div class="cal-container">
						<div class="cal-notes">
							<span class="day" style="text-align: right">간편본인인증</span> <span
								class="date" style="text-align: right; color: #FF1212;">간편한,
								안전한 블록체인</span> <span id="phoneNum" class="date"
								style="text-align: right; color: #FFB4B4;"></span>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="panel panel-default">
					<div class="panel-body">
						<img src="assets/img/board/main_event.png" style="width: 100%;">
					</div>
				</div>
			</div>
		</div>
			...
			<div class="panel panel-default">
				<div class="panel-heading success">
					<h4 class="panel-title">
						<a id="toggleCollapse" data-toggle="collapse"
							data-parent="#accordion" href="#ac4-1" class="collapsed"
							aria-expanded="false"
							style="text-align: center; border: 1px solid lightgray;"> <i
							id="arrow" class="icon s7-angle-right-circle"></i> 인증내역보기
						</a>
					</h4>
				</div>
