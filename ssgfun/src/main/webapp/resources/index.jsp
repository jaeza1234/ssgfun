...
<body>
	<div class="am-wrapper">
		<img class="bgimg" src="assets/img/bgimg/IMG_6811.PNG">
					...
					<ul class="nav navbar-nav am-user-nav">
						<li class="dropdown"><a href="#" data-toggle="dropdown"
							role="button" aria-expanded="false" class="dropdown-toggle"><img
								src="assets/img/avatar.jpg"><span class="user-name">Samantha
										...
										<div class="am-scroller nano">
											<div class="content nano-content">
												<ul>
													...
													<li><a href="#">
															<div class="logo">
																<img src="assets/img/avatar5.jpg">
															</div>
															<div class="user-content">
									...
									<div class="list">
										<div class="content">
											<ul>
												...
												<li>
													<div class="logo">
														<img src="assets/img/dribbble.png">
													</div>
													<div class="field">
														<span>Dribbble</span>
														<div class="switch-container">
		...
		<div class="am-left-sidebar">
			<div class="content">
			<img class="sidebarimg" src="assets/img/bgimg/sidebar.jpg">
			<div class="funDiv">
				<a href="fun.jsp">
