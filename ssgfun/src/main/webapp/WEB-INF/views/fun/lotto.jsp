			...
			$.ajax({
				...
				success: function(data) {
					...
					$.each(data, function(idx, lotto) {
						...
						txt += '<td>' + (idx+1) + '</td>';
						txt += '<td>' + (idx+1) + '</td>';
						if(lotto.ulnum1 == num[0] || lotto.ulnum1 == num[1] || lotto.ulnum1 == num[2] || lotto.ulnum1 == num[3] || lotto.ulnum1 == num[4] || lotto.ulnum1 == num[5] || lotto.ulnum1 == num[5]) {
