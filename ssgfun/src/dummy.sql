...
VALUES('p908uz', 'ssg2017', 'ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½', 'p908uz@shinsegae.com', 01011112222, '111-1111-1111', DEFAULT, DEFAULT, NULL);
INSERT INTO T_USER(UNO, UPWD, UNAME, UEMAIL, UPHONE, UACCOUNT, UMONEY, REGDATE, MODDATE)
VALUES('p908v2', 'ssg2017', 'ï¿½ï¿½ï¿½ï¿½È¯', 'p908v2@shinsegae.com', 01022223333, '222-3333-3333', DEFAULT, DEFAULT, NULL);
INSERT INTO T_USER(UNO, UPWD, UNAME, UEMAIL, UPHONE, UACCOUNT, UMONEY, REGDATE, MODDATE)
VALUES('p908v3', 'ssg2017', 'ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½', 'p908v3@shinsegae.com', 01044445555, '444-5555-5555', DEFAULT, DEFAULT, NULL);
...
VALUES(SEQ_USER_LOTTO.NEXTVAL, '778È¸ï¿½ï¿½', 1, 2, 3, 4, 5, 6, '2017-10-17', NULL, 'p908uz');
INSERT INTO T_USER_LOTTO(ULNO, ULNAME, ULNUM1, ULNUM2, ULNUM3, ULNUM4, ULNUM5, ULNUM6, REGDATE, MODDATE, UNO)
VALUES(SEQ_USER_LOTTO.NEXTVAL, '778È¸ï¿½ï¿½', 1, 2, 3, 4, 5, 33, '2017-10-18', NULL, 'p908uz');
INSERT INTO T_USER_LOTTO(ULNO, ULNAME, ULNUM1, ULNUM2, ULNUM3, ULNUM4, ULNUM5, ULNUM6, REGDATE, MODDATE, UNO)
VALUES(SEQ_USER_LOTTO.NEXTVAL, '778È¸Â÷', 1, 2, 3, 4, 5, 44, '2017-10-19', NULL, 'p908uz');
INSERT INTO T_USER_LOTTO(ULNO, ULNAME, ULNUM1, ULNUM2, ULNUM3, ULNUM4, ULNUM5, ULNUM6, REGDATE, MODDATE, UNO)
VALUES(SEQ_USER_LOTTO.NEXTVAL, '778È¸Â÷', 6, 21, 35, 36, 37, 41, '2017-10-27', NULL, 'p908uz');
INSERT INTO T_USER_LOTTO(ULNO, ULNAME, ULNUM1, ULNUM2, ULNUM3, ULNUM4, ULNUM5, ULNUM6, REGDATE, MODDATE, UNO)
VALUES(SEQ_USER_LOTTO.NEXTVAL, '778È¸ï¿½ï¿½', 1, 2, 3, 4, 5, 44, '2017-10-19', NULL, 'p908uz');
...
VALUES(SEQ_USER_COUPON.NEXTVAL, '1000ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½', NULL, NULL, DEFAULT, NULL, 'p908uz');
